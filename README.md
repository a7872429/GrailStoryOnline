...
這是《傳說紀行》的完整網頁遊戲原始碼。GitHub 用來保存程式碼；Cloudflare Workers 與 D1 負責二人或四人房間、玩家同步及牌局資料。四人隊伍座位與回合順序固定為紅一、藍一、紅二、藍二。

> 不能只開啟 GitHub Pages。GitHub Pages 沒有伺服器與資料庫，聯網房間功能會失效。
